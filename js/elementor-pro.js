            ...
            value: function (e) {
              ...
              return (
                ...
                "background" === i &&
                  ...
                  (u.addBackgroundLayerTo = " > .elementor-element-populated"),
                u
              );
            },
          },
        ...
        o(t, [
          ...
          },
          {
            ...
            value: function () {
              ...
              this.$element
                .find(t.selectors.galleryItems)
                .not(t.selectors.galleryItemsHidden)
                .attr(
                  "data-elementor-lightbox-slideshow",
                  e + "_" + this.getID()
                );
          ...
          },
          {
            key: "onInit",
            value: function () {
              for (var e, n = arguments.length, o = Array(n), r = 0; r < n; r++)
                o[r] = arguments[r];
              (e = i(
                t.prototype.__proto__ || Object.getPrototypeOf(t.prototype),
                "onInit",
      ...
      return (
        ...
        o(t, [
            ...
            value: function (e) {
              ...
              if (
                ...
                (n = e.hasClass(t.firstLevelListItem)
                  ? e.parent().next()
                  : e.parents("." + t.listWrapper).eq(-2)).length
                  ? ((this.$activeList = n),
              ...
              0 === t &&
                ...
                elementorFrontend.waypoint(
                  ...
                  function (o) {
                    n.itemClicked ||
                      ("down" === o
                        ? n.activateItem(n.$listItemTexts.eq(t + 1))
                        : n.activateItem(e));
                  },
          ...
          },
          {
            ...
            value: function (e) {
              for (
                ...
                if (
                  (0 === r.level && (s += " " + t.classes.firstLevelListItem),
                  e > r.level)
                )
                  break;
                if (e === r.level) {
                  (i += '<li class="' + t.classes.listItem + '">'),
                    (i += '<div class="' + t.classes.listTextWrapper + '">');
                  var a =
                    '<a href="#' +
                    t.classes.headingAnchor +
                    "-" +
                  ...
                  "bullets" === n.marker_view &&
                    o &&
                    (a = '<i class="' + o.value + '"></i>' + a),
                    (i += a),
                    (i += "</div>"),
                    this.listItemPointer++;
                  var l = this.headingsData[this.listItemPointer];
                  l && e < l.level && (i += this.getNestedLevel(l.level)),
                    (i += "</li>");
                }
              }
            ...
            value: function () {
              if (elementorFrontend.isEditMode())
                return this.elements.$tocBody.html(
                  elementorPro.translate("toc_no_headings_found")
                );
            },
          },
          {
          ...
          },
          {
            ...
            value: function () {
              for (
                var e, n = this, o = arguments.length, i = Array(o), r = 0;
                r < o;
                r++
              )
                i[r] = arguments[r];
          ...
          },
          {
            ...
            value: function (e) {
              ...
              var n = jQuery(e.target),
                ...
                r = void 0;
              i &&
                n.hasClass(this.getSettings("classes.firstLevelListItem")) &&
                o.is(":visible") &&
                (r = !0),
                this.activateItem(n),
                i && r && o.slideUp();
  ...
  function (e, t, n) {
    ...
    e.exports = o.extend({
      ...
      arrangeGrid: function () {
        ...
        c.css({ opacity: 0, transform: "scale3d(0.2, 0.2, 1)" }),
          a.each(function () {
            var n = e(this),
